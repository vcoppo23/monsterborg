...
class WebServer(SocketServer.BaseRequestHandler):
    def handle(self):
        ...
        if getPath.startswith('/cam.jpg'):
            ...
            httpText += '     Drive(-1,-1)\n'
            httpText += '     break;\n'
            httpText += '   case "Up": // IE/Edge specific value\n'
            httpText += '   case "ArrowUp":\n'
            httpText += '     Drive(1,1)\n'
            httpText += '     break;\n'
            httpText += '   case "Left": // IE/Edge specific value\n'
            httpText += '   case "ArrowLeft":\n'
            httpText += '     // Do something for "left arrow" key press.\n'
            httpText += '     break;\n'
            httpText += '   case "Right": // IE/Edge specific value\n'
            httpText += '   case "ArrowRight":\n'
            httpText += '     // Do something for "right arrow" key press.\n'
            httpText += '     break;\n'
            httpText += '   case "Enter":\n'
            httpText += '     // Do something for "enter" or "return" key press.\n'
            httpText += '     break;\n'
            httpText += '   case "Esc": // IE/Edge specific value\n'
            httpText += '   case "Escape":\n'
            httpText += '     // Do something for "esc" key press.\n'
            httpText += '     break;\n'
            httpText += '   default:\n'
            httpText += '     return; // Quit when this doesn\'t handle the key event.\n'
            httpText += ' }\n'
            httpText += '\n'
            httpText += ' // Cancel the default action to avoid it being handled twice\n'
            httpText += ' event.preventDefault();\n'
            httpText += '}, true);\n'
            httpText += '//--></script>\n'
            httpText += '</head>\n'
            httpText += '<body>\n'
